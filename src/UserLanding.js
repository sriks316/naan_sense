    ...
    return (
        <React.Fragment>
          <section className="section-grey">
            ...
            <h3 align='center'> Welcome User {this.state.userinfo.name}</h3>
          </section>
          <section className="section-beige">
              <div class="container">
                <div class="card-deck mb-3 text-center">
                  ...
                  <div class="card mb-4 shadow-sm">
                    <div class="card-header">
                      <h4 class="my-0 font-weight-normal">Last Week</h4>
                    </div>
                    <div align='center'class="card-body">
                      <ul class="list-unstyled mt-3 mb-4">
                        <li><ReactPlayer url='https://soundcloud.com/food-heaven-podcast/how-to-separate-working-out' width= '80%' height = '80%' /></li>
                  ...
                  <div class="card mb-4 shadow-sm">
                    <div class="card-header">
                      <h4 class="my-0 font-weight-normal">Specials</h4>
                    </div>
                    <div align='center' class="card-body">
                      <ul class="list-unstyled mt-3 mb-4">
                        <li><ReactPlayer url='https://soundcloud.com/food-heaven-podcast/how-to-separate-working-out' width= '80%' height = '80%' /></li>
